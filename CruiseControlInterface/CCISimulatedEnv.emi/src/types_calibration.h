 ...
 */
#define MAX_FIREABLE_LENGTH		(1)			// Maximum number of transitions in a compound transition of the model.
#define MAX_OUTGOINGS			(12)			// Maximum number of outgoings transitions of a vertex.
