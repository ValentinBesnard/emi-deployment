...
struct Store {
	...
	PwmLed_store instMain_env_envLed;
...
#define ABSTRACT_MUTABILITY_PwmLed  bool ledPort_isMutable		:1;	\
	bool timer_isMutable		:1;	\
	bool channel_isMutable		:1;

#define ABSTRACT_MUTABILITY_GpioLed  bool port_isMutable		:1;	\
...
#define ABSTRACT_PROPERTIES_TYPE_PwmLed  PwmLed_properties_ro * ledPort_type;	\
	PwmLed_od * timer_type;	\
	PwmLed_od * channel_type;

#define ABSTRACT_PROPERTIES_TYPE_GpioLed  GpioLed_od * port_type;	\
	GpioLed_od * pin_type;
...
struct ActiveObjects {
	...
	PwmLed_Object * instMain_env_envLed;
...
struct PropertiesRO {
	...
	PwmLed_properties_ro instMain_env_envLed;
