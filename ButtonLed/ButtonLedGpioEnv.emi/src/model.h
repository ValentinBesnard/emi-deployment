...
typedef struct PwmLed_store PwmLed_store;
typedef struct PwmLed_ep_params PwmLed_ep_params;
typedef struct PwmLed_od  PwmLed_od;
...
typedef struct PwmLed_properties_ro PwmLed_properties_ro;
...
typedef struct PwmLed_mutability PwmLed_mutability;
...
typedef struct PwmLed_PropertiesTypes PwmLed_PropertiesTypes;
...
typedef struct PwmLed_classInfo PwmLed_classInfo;
...
SPECIFIC_TYPEDEF_Object(PwmLed)
...
typedef struct PwmLed_operations PwmLed_operations;
typedef void (*PwmLed_method)(PwmLed_Object * this, void * __unused_params);
...
/**
 * The object data (e.g., attributes) type for the PwmLed class.
 */
struct PwmLed_od {
...
/**
 * The store type for the PwmLed class. It contains:
 * 		 - value of its current state
 * 		 - content of its event pool
 * 		 - values of its attributes
 */
...
struct Store {
	...
	GpioLed_store instMain_env_envLed;
	GpioButton_store instMain_env_envButton;
...
#define ABSTRACT_MUTABILITY_PwmLed  bool timer_isMutable		:1;	\
	bool channel_isMutable		:1;

#define ABSTRACT_MUTABILITY_GpioLed  bool ledPort_isMutable		:1;	\
	bool port_isMutable		:1;	\
	bool pin_isMutable		:1;

#define ABSTRACT_MUTABILITY_GpioButton  bool peer_isMutable		:1;	\
	bool port_isMutable		:1;	\
	bool pin_isMutable		:1;

#define ABSTRACT_MUTABILITY_Env  bool envLed_isMutable		:1;	\
	bool envButton_isMutable		:1;	\
	bool envLedPort_isMutable		:1;	\
	bool envButtonPort_isMutable		:1;

#define ABSTRACT_MUTABILITY_EnvLedPort  bool systemLightPort_isMutable		:1;	\
	bool led_isMutable		:1;

#define ABSTRACT_MUTABILITY_EnvButtonPort  bool button_isMutable		:1;	\
	bool systemButtonPort_isMutable		:1;
...
#define ABSTRACT_MUTABILITY_Main  bool system_isMutable		:1;	\
	bool env_isMutable		:1;
...
#define ABSTRACT_PROPERTIES_TYPE_PwmLed  PwmLed_od * timer_type;	\
	PwmLed_od * channel_type;

#define ABSTRACT_PROPERTIES_TYPE_GpioLed  GpioLed_properties_ro * ledPort_type;	\
	GpioLed_od * port_type;	\
	GpioLed_od * pin_type;

#define ABSTRACT_PROPERTIES_TYPE_GpioButton  GpioButton_properties_ro * peer_type;	\
	GpioButton_od * port_type;	\
	GpioButton_od * pin_type;

#define ABSTRACT_PROPERTIES_TYPE_Env  Env_properties_ro * envLed_type;	\
	Env_properties_ro * envButton_type;	\
	Env_properties_ro * envLedPort_type;	\
	Env_properties_ro * envButtonPort_type;

#define ABSTRACT_PROPERTIES_TYPE_EnvLedPort  EnvLedPort_properties_ro * systemLightPort_type;	\
	EnvLedPort_properties_ro * led_type;

#define ABSTRACT_PROPERTIES_TYPE_EnvButtonPort  EnvButtonPort_properties_ro * button_type;	\
	EnvButtonPort_properties_ro * systemButtonPort_type;
...
#define ABSTRACT_PROPERTIES_TYPE_Main  Main_properties_ro * system_type;	\
	Main_properties_ro * env_type;
...
struct PwmLed_PropertiesTypes {
	...
	ABSTRACT_PROPERTIES_TYPE_PwmLed
};
...
struct PwmLed_classInfo {
	union {
		UML_Class * type;
		const PwmLed_PropertiesTypes * properties_types; // Should not be dereferenced
	};
	PwmLed_mutability mutability;
};
...
SPECIFIC_STRUCT_ActiveObject(PwmLed)
...
struct ActiveObjects {
	...
	GpioLed_Object * instMain_env_envLed;
	GpioButton_Object * instMain_env_envButton;
	#ifdef WITH_OBSERVERS
	#endif /* WITH_OBSERVERS */
};
...
struct Env_properties_ro {
	GpioLed_Object * envLed;
	GpioButton_Object * envButton;
...
/**
 * The PwmLed_properties_ro type used to link instances of the PwmLed class with their properties.
 */
...
struct PropertiesRO {
	...
	GpioLed_properties_ro instMain_env_envLed;
	GpioButton_properties_ro instMain_env_envButton;
...
struct Ports {
	...
	UML_Port * DIL__POINT__GpioButton__POINT__peer;
